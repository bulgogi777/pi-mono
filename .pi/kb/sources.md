...
- Claims about behavior cite `file:line` in the pinned tree — always the **Current pin** declared above (today: `53fa77cc`, `v0.84.1`), never a prior pin. *This line has drifted before; when bumping the pin, update it here too or the confidence rule silently authorizes stale cites.*
